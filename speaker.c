...
const int Elise_Tune_start[] = {MI_02, RE_02_H, MI_02, RE_02_H, MI_02, TI_01, RE_02, DO_02, '/0'};
const int Elise_Beats_start[] = {BEAT_1_8, BEAT_1_8, BEAT_1_8, BEAT_1_8, BEAT_1_8, BEAT_1_8, BEAT_1_8, BEAT_1_8, BEAT_1_8};
...
void init_speaker(void)
{
	...
	TCCR1A = (1<<COM1A0); // COM3A0 : 비교일치시 PE3 출력 반전 (PAGE.328 표14-6 참고)
